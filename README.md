...
GitHub Projects Viewer rebuilt on [Cais](https://github.com/puppe1990/cais): same catalog UI, server-side GitHub API, SQLite cache, and background jobs for traffic snapshots.
